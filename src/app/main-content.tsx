                ...
                <div className="h-14 border-b border-neutral-200/60 px-6 flex items-center justify-between bg-neutral-50/50">
                  <div className="inline-flex bg-white/60 border border-neutral-200/60 p-0.5 h-9 rounded-lg shadow-sm">
                    <button
                      ...
                      className={`px-4 py-1.5 text-sm font-medium rounded-md transition-all ${activeView === "preview" ? "bg-white text-neutral-900 shadow-sm" : "text-neutral-600"}`}
                    >
                      Preview
                    </button>
                    <button
                      onClick={() => setActiveView("code")}
                      className={`px-4 py-1.5 text-sm font-medium rounded-md transition-all ${activeView === "code" ? "bg-white text-neutral-900 shadow-sm" : "text-neutral-600"}`}
                    >
                      Code
                    </button>
                  </div>
